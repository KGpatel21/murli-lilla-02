  ...
  return (
    ...
    >
      ...
      <div className="hero-bg absolute inset-0 -z-10 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(0,0,0,0.72)_0%,rgba(0,0,0,0.55)_28%,rgba(0,0,0,0.3)_55%,rgba(0,0,0,0.08)_100%)]" />
        <div className="absolute inset-0 bg-[linear-gradient(to_top,rgba(0,0,0,0.5)_0%,rgba(0,0,0,0.15)_40%,rgba(0,0,0,0)_68%)]" />
      </div>
