  ...
  return (
    <footer className="relative w-full overflow-clip text-white" style={{ background: "#000000" }}>
      ...
      <div className="frame" style={{ paddingTop: 72, paddingBottom: 0 }}>
        ...
        <div className="footer-grid">
          ...
          <div>
            ...
            <address
              ...
              style={{ gap: 14, fontSize: 15.5, lineHeight: 1.5 }}
            >
              <span style={{ color: "rgba(255,255,255,0.75)" }}>
                MurliLeela Private Limited
              </span>
              <span style={{ color: "rgba(255,255,255,0.55)" }}>
                Jodhpur, Rajasthan · Ahmedabad, Gujarat
              </span>
              <a href="tel:+911484423082" className="footer-link" style={{ color: "rgba(255,255,255,0.55)" }}>
                +91 1484 423082
              </a>
              <a
                href="mailto:MurlileelaPvt.Lim@gmail.com"
                className="footer-link"
                style={{ color: "rgba(255,255,255,0.55)", wordBreak: "break-all" }}
              >
        ...
        <div
          aria-hidden
          style={{ height: 1, background: "rgba(255,255,255,0.14)", marginTop: 64 }}
        />

        {/* Bottom row */}
        <div
          className="footer-bottom"
          style={{ paddingTop: 26, paddingBottom: 30 }}
        >
          ...
          <div className="flex items-center" style={{ gap: 28, fontSize: 15, color: "rgba(255,255,255,0.6)" }}>
            <Link href="#" className="footer-link" style={{ whiteSpace: "nowrap" }}>
              Terms of use
            </Link>
            <Link href="#" className="footer-link" style={{ whiteSpace: "nowrap" }}>
              Privacy policy
          ...
          <div className="flex items-center" style={{ gap: 26 }}>
            {Object.entries(SOCIAL_PATHS).map(([name, d]) => (
              <a
                key={name}
                href="#"
                aria-label={`MurliLeela on ${name === "x" ? "X" : name}`}
